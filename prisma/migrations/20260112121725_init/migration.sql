...
-- AddForeignKey
ALTER TABLE "tier_rules" ADD CONSTRAINT "tier_rules_commissionAgreementId_fkey" FOREIGN KEY ("commissionAgreementId") REFERENCES "commission_agreements"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
